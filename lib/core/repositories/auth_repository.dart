    ...
    try {
      ...
      if (authResponse.statusCode == 200) {
        ...
        return ResponseMessage(
            status: 200, body: user, message: 'Autenticazione riuscita!');
      }

      return ResponseMessage(
          status: 401, body: null, message: 'Credenziali errate!');
    } catch (err) {
      return ResponseMessage(
          status: 500, body: null, message: 'Abbiamo riscontrato un problema!');
    }
  }
